const products = [
  ...
  },
  {
    ...
    description:
      'Xbox Series S, the smallest, sleekest Xbox ever. At 60% smaller than Xbox Series X, it delivers the speed and performance of a next-gen, all-digital console at an accessible price point',
    brand: 'Xbox',
    category: 'Gaming',
    price: 299.99,
    countInStock: 20,
